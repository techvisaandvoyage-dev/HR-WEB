...
const EmployeeMessages = () => {
  ...
  const fetchConversations = async () => {
    try {
      const res = await fetch('https://chocolate-trout-143776.hostingersite.com/api/employee/messages/conversations', {
  ...
  const fetchMessages = async (applicationId) => {
    try {
      const res = await fetch(`https://chocolate-trout-143776.hostingersite.com/api/employee/messages/applications/${applicationId}`, {
        headers: { Authorization: `Bearer ${localStorage.getItem('employeeToken')}` }
      });
      const data = await res.json();
      if (data.success) {
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await fetch(`https://chocolate-trout-143776.hostingersite.com/api/employee/messages/applications/${selectedChat.applicationId}`, {
        method: 'POST',
        headers: {
