...
const CompanyProfileTab = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await fetch('https://hr-website-kzdw.onrender.com/api/employer/auth/me', {
        headers: {
  ...
  const handleSaveAll = async () => {
    try {
      ...
      const response = await fetch('https://hr-website-kzdw.onrender.com/api/employer/auth/update', {
        method: 'PUT',
        headers: {
