      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        <div className="flex-1 overflow-y-auto p-10 relative">
          <div className="max-w-[1200px] mx-auto w-full">
            <Routes>
              <Route index element={<DashboardOverview employerProfile={employerProfile} jobs={jobs} candidates={candidates} toggleJobStatus={toggleJobStatus} />} />
              ...
              <Route path="/candidates" element={<AllEmployeesTab />} />
