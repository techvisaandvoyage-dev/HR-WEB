                            ...
                            <div className="border-l-2 border-gray-100 ml-1.5 space-y-4 py-1">
                              ...
                              {(exp.roles && exp.roles.length > 0 ? exp.roles : [exp]).map((role, rIndex) => (
                                <div key={rIndex} className="relative pl-4">
                                  ...
                                  <p className="text-xs text-[#18a058] font-semibold mb-1">
                                    {role.startDate ? new Date(role.startDate).toLocaleDateString() : 'N/A'} - {role.currentJob ? 'Present' : (role.endDate ? new Date(role.endDate).toLocaleDateString() : 'N/A')}
                                  </p>
